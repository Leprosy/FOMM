 ...
 * @author mrojas
 */
public class Quests extends javax.swing.JDialog {
    ...
    public Quests(java.awt.Frame parent, boolean modal, RPG.Party P) {
        super(parent, modal);
        this.P = P;
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                Quests dialog = new Quests(new javax.swing.JFrame(), true, new RPG.Party(1, 1));
